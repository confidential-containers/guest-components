...
pub enum SignatureError {
    ...
    #[error("Malwared image policy file")]
    MalwaredPolicyFile,
    ...
    #[error("Malwared simple signing sigstore config")]
    MalwaredSimpleSigningSigstoreConfig,
...
impl SignatureValidator {
    ...
    pub(crate) async fn new(
        ...
        let policy: Policy =
            serde_json::from_slice(policy).map_err(|_| SignatureError::MalwaredPolicyFile)?;
        ...
        let simple_signing_sigstore_config = match _simple_signing_sigstore_config {
            Some(cfg) => {
                ...
                let mut sigstore_config: policy::SigstoreConfig = serde_yaml::from_slice(&cfg)
                    ...
                    .map_err(|_| SignatureError::MalwaredSimpleSigningSigstoreConfig)?;
                sigstore_config
