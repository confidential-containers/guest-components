...
pub mod attestation_agent_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_tee_metadata(
            &mut self,
            request: impl tonic::IntoRequest<super::GetTeeMetadataRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetTeeMetadataResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/attestation_agent.AttestationAgentService/GetTeeMetadata",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod attestation_agent_service_server {
    ...
    pub trait AttestationAgentService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn get_tee_metadata(
            &self,
            request: tonic::Request<super::GetTeeMetadataRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetTeeMetadataResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/attestation_agent.AttestationAgentService/GetTeeMetadata" => {
                    #[allow(non_camel_case_types)]
                    struct GetTeeMetadataSvc<T: AttestationAgentService>(pub Arc<T>);
                    impl<
                        T: AttestationAgentService,
                    > tonic::server::UnaryService<super::GetTeeMetadataRequest>
                    for GetTeeMetadataSvc<T> {
                        type Response = super::GetTeeMetadataResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AttestationAgentService>::get_tee_metadata(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetTeeMetadataSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
