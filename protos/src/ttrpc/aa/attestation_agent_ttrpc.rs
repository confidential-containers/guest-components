...
impl AttestationAgentServiceClient {
    ...
    pub async fn get_tee_topology(&self, ctx: ttrpc::context::Context, req: &super::attestation_agent::GetTeeTopologyRequest) -> ::ttrpc::Result<super::attestation_agent::GetTeeTopologyResponse> {
        let mut cres = super::attestation_agent::GetTeeTopologyResponse::new();
        ::ttrpc::async_client_request!(self, ctx, req, "attestation_agent.AttestationAgentService", "GetTeeTopology", cres);
    }
}
...
struct GetTeeTopologyMethod {
    service: Arc<dyn AttestationAgentService + Send + Sync>,
}

#[async_trait]
impl ::ttrpc::r#async::MethodHandler for GetTeeTopologyMethod {
    async fn handler(&self, ctx: ::ttrpc::r#async::TtrpcContext, req: ::ttrpc::Request) -> ::ttrpc::Result<::ttrpc::Response> {
        ::ttrpc::async_request_handler!(self, ctx, req, attestation_agent, GetTeeTopologyRequest, get_tee_topology);
    }
}
...
pub trait AttestationAgentService: Sync {
    ...
    async fn get_tee_topology(&self, _ctx: &::ttrpc::r#async::TtrpcContext, _: super::attestation_agent::GetTeeTopologyRequest) -> ::ttrpc::Result<super::attestation_agent::GetTeeTopologyResponse> {
        Err(::ttrpc::Error::RpcStatus(::ttrpc::get_status(::ttrpc::Code::NOT_FOUND, "/attestation_agent.AttestationAgentService/GetTeeTopology is not supported".to_string())))
    }
}
...
pub fn create_attestation_agent_service(service: Arc<dyn AttestationAgentService + Send + Sync>) -> HashMap<String, ::ttrpc::r#async::Service> {
    ...
    methods.insert("GetTeeTopology".to_string(),
                    Box::new(GetTeeTopologyMethod{service: service.clone()}) as Box<dyn ::ttrpc::r#async::MethodHandler + Send + Sync>);
