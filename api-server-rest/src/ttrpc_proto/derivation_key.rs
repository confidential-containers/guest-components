...
//! Generated file from `derivation_key.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_5_1;

// @@protoc_insertion_point(message:derivation_key.GetEvidenceRequest)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct GetEvidenceRequest {
    // message fields
    // @@protoc_insertion_point(field:derivation_key.GetEvidenceRequest.RuntimeData)
    pub RuntimeData: ::std::vec::Vec<u8>,
    // special fields
    // @@protoc_insertion_point(special_field:derivation_key.GetEvidenceRequest.special_fields)
...
// @@protoc_insertion_point(message:derivation_key.GetEvidenceResponse)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct GetEvidenceResponse {
    // message fields
    // @@protoc_insertion_point(field:derivation_key.GetEvidenceResponse.Evidence)
    pub Evidence: ::std::vec::Vec<u8>,
    // special fields
    // @@protoc_insertion_point(special_field:derivation_key.GetEvidenceResponse.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
// @@protoc_insertion_point(message:derivation_key.GetTokenRequest)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct GetTokenRequest {
    // message fields
    // @@protoc_insertion_point(field:derivation_key.GetTokenRequest.TokenType)
    pub TokenType: ::std::string::String,
    // special fields
    // @@protoc_insertion_point(special_field:derivation_key.GetTokenRequest.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
// @@protoc_insertion_point(message:derivation_key.GetTokenResponse)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct GetTokenResponse {
    // message fields
    // @@protoc_insertion_point(field:derivation_key.GetTokenResponse.Token)
    pub Token: ::std::vec::Vec<u8>,
    // special fields
    // @@protoc_insertion_point(special_field:derivation_key.GetTokenResponse.special_fields)
    pub special_fields: ::protobuf::SpecialFields,
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x14derivation_key.proto\x12\x0ederivation_key\"6\n\x12GetEvidenceRequ\
    est\x12\x20\n\x0bRuntimeData\x18\x01\x20\x01(\x0cR\x0bRuntimeData\"1\n\
    \x13GetEvidenceResponse\x12\x1a\n\x08Evidence\x18\x01\x20\x01(\x0cR\x08E\
    vidence\"/\n\x0fGetTokenRequest\x12\x1c\n\tTokenType\x18\x01\x20\x01(\tR\
    \tTokenType\"(\n\x10GetTokenResponse\x12\x14\n\x05Token\x18\x01\x20\x01(\
    \x0cR\x05Token2\xc0\x01\n\x17AttestationAgentService\x12V\n\x0bGetEviden\
    ce\x12\".derivation_key.GetEvidenceRequest\x1a#.derivation_key.GetEviden\
    ceResponse\x12M\n\x08GetToken\x12\x1f.derivation_key.GetTokenRequest\x1a\
    \x20.derivation_key.GetTokenResponseb\x06proto3\
";
