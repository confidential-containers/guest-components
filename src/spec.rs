...
/// MEDIA_TYPE_LAYEE_GZIP_ENC is MIME type used for encrypted compressed layers.
pub const MEDIA_TYPE_LAYEE_GZIP_ENC: &str = "application/vnd.oci.image.layer.v1.tar+gzip+encrypted";
