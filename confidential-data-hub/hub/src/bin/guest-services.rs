...
enum Commands {
    ...
    ImagePull {
        ...
        #[arg(short, long, default_value = "/run/guest-services/imagepull.socket")]
        socket: PathBuf,
    ...
    SealedSecrets {
        #[arg(
            short,
            long,
            default_value = "/run/guest-services/sealedsecrets.socket"
        )]
        socket: PathBuf,
        #[arg(short, long, default_value = "/run/measured-cfg")]
        config_dir: PathBuf,
    ...
    SecureMount {
        #[arg(short, long, default_value = "/run/guest-services/securemount.socket")]
        socket: PathBuf,
        #[arg(short, long, default_value = "/run/measured-cfg")]
        config_dir: PathBuf,
    },
    ...
    GetResource {
        #[arg(short, long, default_value = "/run/guest-services/getresource.socket")]
        socket: PathBuf,
        #[arg(short, long, default_value = "/run/measured-cfg")]
        config_dir: PathBuf,
    },
