...
impl TdxAttester {
    ...
    /// This is an ioctl implementation that writes to the RTMR to fit with **out-of-tree**
    /// linux kernel drivers in a way that DCAP does, i.e.
    ///
    ///  <https://github.com/intel/confidential-computing.tee.dcap/blob/3aa24f6df004f092556aef10e0ab422cb0395e38/QuoteGeneration/quote_wrapper/tdx_attest/tdx_attest.c#L46-L55>
    ///
    /// It is used to write to the RTMR when the kernel version is less than 6.16.
    /// When the kernel version is >= 6.16, the sysfs path is used instead to extend the RTMR.
    /// This is a fallback mechanism for platforms that do not support the sysfs path.
    ///
    /// TODO: delete this once the sysfs is supported on all released kernels.
